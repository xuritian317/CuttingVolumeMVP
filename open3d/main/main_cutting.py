...
def main():
    ...
    print("->正在加载点云... ")
    pcd = o3d.io.read_point_cloud("../cuttings2/11.ply")
    # print(pcd)
    ...
    # 点云裁切
    vol = o3d.visualization.read_selection_polygon_volume("cropped_cutting.json")
    ...
    # 平面切割 获得多目标(立于平面之上)
    plane_model, inliers = downpcd.segment_plane(distance_threshold=0.002,
                                                 ransac_n=5,
                                                 num_iterations=1000)
